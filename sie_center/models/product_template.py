...
class MyProduct(models.Model):
    ...
    def action_recalculate_avgcost(self):
        ...
        for product in self:
            ...
            log.append("Las siguientes lineas de valoracion y contabilidad fueron eliminadas")
            ...
            for valuation in valuation_lines:
                ...
                log.append("""Referencia Valoracion Inventario:%s, Referencia Contabilidad:%s"""
